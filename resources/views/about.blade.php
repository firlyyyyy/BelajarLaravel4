    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/about"
                                    class="rounded-3xl bg-slate-600 px-3 py-2 text-sm font-medium text-white hover:bg-slate-400 hover:text-white duration-500 select-none">About</a>
                                <a href="/blog"
            ...
            <div x-show = 'isOpen' class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/" class="block rounded-3xl px-3 py-2 text-base font-medium text-gray-300"
                        aria-current="page">Home</a>
                    <a href="/about"
                        class="block rounded-3xl px-3 bg-slate-600 py-2 text-base font-medium text-white hover:bg-slate-400 hover:text-white">About</a>
                    <a href="/blog"
                        class="block rounded-3xl px-3 py-2 text-base font-medium text-gray-300 hover:bg-slate-400 hover:text-white">Blog</a>
                    <a href="/contact"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900 select-none">About</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
